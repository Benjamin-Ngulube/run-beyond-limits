    ...
    <section id="gallery" className="section-padding bg-white">
      <div className="container mx-auto">
        <div className="text-center mb-12">
          <h2 className="heading-lg text-marathon-darkBlue mb-4">Event Gallery</h2>
          <div className="w-24 h-1 bg-marathon-blue mx-auto mb-6"></div>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Explore our collection of photos from previous events, training sessions, 
            and the beautiful routes you'll experience during the marathon.
          </p>
        </div>
        ...
        {selectedImage && (
          <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50 p-4" onClick={() => setSelectedImage(null)}>
            <div className="bg-white rounded-lg overflow-hidden max-w-4xl max-h-[90vh] w-full" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="p-4">
                ...
                <p className="text-gray-500 capitalize">{selectedImage.category}</p>
              </div>
            </div>
          </div>
        )}
